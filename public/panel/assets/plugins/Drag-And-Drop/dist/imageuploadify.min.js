...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>Перетащите или выбирите фото</span><button type="button"class="btn btn-default">Выбрать</button></div></div>`);
			...
			const readingFile = (id, file) => {
				...
				let container = $(`<div class='imageuploadify-container' style='margin-top: 10px;'><button type='button'class='btn btn-danger bx bx-x'></button><input value='Загрузить' type='submit' style='border: none; margin-left: 10px; border-radius: 10px; padding: 8px; padding-left: 20px; padding-right: 20px;'><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`);
