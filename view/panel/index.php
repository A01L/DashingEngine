...
<body class="bg-theme bg-theme1">
	...
	<script src="public/panel/assets/plugins/vectormap/jquery-jvectormap-2.0.2.min.js"></script>
	<script src="public/panel/assets/plugins/vectormap/jquery-jvectormap-world-mill-en.js"></script>
	<!-- highcharts js -->
	<script src="public/panel/assets/plugins/highcharts/js/highcharts.js"></script>
	<script src="public/panel/assets/plugins/apexcharts-bundle/js/apexcharts.min.js"></script>
	<script src="public/panel/assets/js/index2.js"></script>
	<!--app JS-->
