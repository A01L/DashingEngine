			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xl-9 mx-auto">
						<h6 class="mb-0 text-uppercase">Редактировать пост</h6>
						<hr/>
						<div class="card border-top border-0 border-4 border-white">
							<div class="card-body">
								<div class="border p-4 rounded">
								<form method="post" action="RPosting" enctype="multipart/form-data">
									<input value='<?php echo $pid; ?>' hidden readonly name='pid'>
									<div class="row mb-3">
										<label for="inputConfirmPassword2" class="col-sm-3 col-form-label">Заголовок поста</label>
										<div class="col-sm-9">
											<input value='<?php echo get_data("blogs", "title", "id", $pid); ?>' name="title" type="text" class="form-control" id="inputConfirmPassword2" placeholder="О чем пост...?">
										</div>
									</div>
									<div class="row mb-3">
										<label for="inputAddress4" class="col-sm-3 col-form-label">Контент</label>
										<div class="col-sm-9">
											<textarea name="data" class="form-control" id="inputAddress4" rows="3" placeholder="Содержание поста..."><?php echo get_data("blogs", "data", "id", $pid); ?></textarea>
										</div>
									</div>
									<div class="row">
